...
export function StopIcon({ className = 'w-10 h-10' }: IconProps) {
  return (
...
export function LoadingDotsIcon({ className = 'w-10 h-10' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <circle cx="4" cy="12" r="2" className="animate-bounce" style={{ animationDelay: '0ms' }} />
      <circle cx="12" cy="12" r="2" className="animate-bounce" style={{ animationDelay: '150ms' }} />
      <circle cx="20" cy="12" r="2" className="animate-bounce" style={{ animationDelay: '300ms' }} />
    </svg>
  );
}
